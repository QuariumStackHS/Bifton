...
gcc -lstdc++ ./src/Tasks/BCXX/BiftonCxx/BiftonCxx.o ./src/Tasks/BCXX/BiftonCxx/SHA1/SHA1.o ./src/Tasks/SimpleExecuter.o ./src/Tasks/BCXX/BCXX.o ./src/Tasks/Registry.o ./src/Tasks/ADV/ADV.o ./src/Tasks/xor/Xor.o ./src/Tasks/Install/install.o ./src/Bifton.o -O3  -oBifton
